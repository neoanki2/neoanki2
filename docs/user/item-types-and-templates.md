...
![The Item Types manager]({{ site.baseurl }}/assets/screenshots/item-types.png)
...
![The template editor]({{ site.baseurl }}/assets/screenshots/template-editor.png)
...
![Advanced template settings]({{ site.baseurl }}/assets/screenshots/template-advanced.png)
